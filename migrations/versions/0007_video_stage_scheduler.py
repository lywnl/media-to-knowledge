...
revision: str = "0007_video_stage_scheduler"
down_revision: str | Sequence[str] | None = "0006_audio_document_result"
...
def downgrade() -> None:
    op.drop_index("ix_video_stage_recovery", table_name="video_pipeline_stage")
    op.drop_table("video_pipeline_stage")
