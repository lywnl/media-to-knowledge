...
REQUIREMENT_SPECS: tuple[RequirementSpec, ...] = (
    ...
    RequirementSpec(20, "章节时间点生成视觉候选帧", ("real_media_chain",)),
    RequirementSpec(21, "音频与视觉证据按时间点确定性准备", ("real_media_chain",)),
    RequirementSpec(22, "FFmpeg 关键帧校验与摘要去重", ("real_media_chain",)),
