...
def test_pipeline_public_surface_is_the_single_3_pipeline() -> None:
...
def test_pipeline_run_config_parses_only_3_snapshot() -> None:
...
@pytest.mark.parametrize("version", [None, "1.0.0", "2.0.0", "4.0.0"])
def test_pipeline_run_config_rejects_missing_or_legacy_schema(version: str | None) -> None:
    ...
    assert raised.value.details == {"supported_schema_version": "3.0.0"}
